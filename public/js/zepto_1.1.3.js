...
//animate模块
    ...
    ; (function ($, undefined) {
        ...
        $.fn.slideDown = function (speed, callback) {
            ...
            var height = this.height() === 0 ? historyHt : this.height();
            historyHt = this.height() === 0 ?historyHt : height;
            var top = this.offset().top;
            console.log(historyHt);
            //-------通过伸缩元素高度实现动画-------
              return this.css({
                  position: position,
                  visibility: 'visible',
                  overflow: 'hidden',
                  height: 0
              }).animate({ height: height, top: top}, speed, null, callback);
